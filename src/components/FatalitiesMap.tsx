...
export default function TestingMap(props: any) {
    ...
    return (
        <>
            <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '8%', paddingX: '10px', backgroundColor: '#EFF5F5' }}>
                <Typography variant="body1" component="div">
                    Fatalities by County
                </Typography>
            </Box>

            <MapContainer center={[42.7128, -76.0060]} zoom={7} scrollWheelZoom={false} style={{ height: '90%', width: '100%' }}>
                <TileLayer
                    ...
                    url='https://tiles.stadiamaps.com/tiles/alidade_smooth_dark/{z}/{x}/{y}{r}.png' />
                {
                    countyData.features.map((county: any) => {
                        ...
                        const count = countyData ? (countyData.fatality / countyPopulation) * 100 : 0
